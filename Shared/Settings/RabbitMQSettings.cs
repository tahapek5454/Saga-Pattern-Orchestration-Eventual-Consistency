...
namespace Shared.Settings
{
    public static class RabbitMQSettings
    {
        ...
        public const string Order_OrderFailedEventQueue = "order_order_completed_event_queue";
        public const string Stock_RollbackMessageQueue = "stock_rollback_message_queue";
        public const string Payment_PaymentStartedEventQueue = "payment_started_event_queue";
    }
}
